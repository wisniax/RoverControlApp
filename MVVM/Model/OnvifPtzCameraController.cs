...
namespace RoverControlApp.MVVM.Model
{
	public class OnvifPtzCameraController
	{
		...
		public TimeSpan MinSpanEveryCom =>
			TimeSpan.FromSeconds(1 / MainViewModel.Settings.Settings.LocalSettingsCamera.PtzRequestFrequency);
		...
		private bool UpdateMotion(Vector4 old, Vector4 @new, out Vector4 speed)
		{
			...
			speed = MainViewModel.Settings.Settings.LocalSettingsCamera.CameraInverseAxis ? new Vector4(-@new.X, -@new.Y, @new.Z, @new.W) : @new;

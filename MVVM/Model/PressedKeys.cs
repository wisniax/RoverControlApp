...
namespace RoverControlApp.MVVM.Model
{
	public class PressedKeys
	{
		...
		public PressedKeys()
		{
			...
			_roverDriveControllerPreset = MainViewModel.Settings.Joystick.NewFancyRoverController
		...
		private void HandleCameraInputEvent()
		{
			...
			absoluteVector4.X = Mathf.IsEqualApprox(velocity.X, 0f, Mathf.Max(0.1f, MainViewModel.Settings.Joystick.Deadzone)) ? 0 : velocity.X;
			absoluteVector4.Y = Mathf.IsEqualApprox(velocity.Y, 0f, Mathf.Max(0.1f, MainViewModel.Settings.Joystick.Deadzone)) ? 0 : velocity.Y;
			velocity = Input.GetVector("camera_zoom_out", "camera_zoom_in", "camera_focus_out", "camera_focus_in");
			absoluteVector4.Z = Mathf.IsEqualApprox(velocity.X, 0f, Mathf.Max(0.1f, MainViewModel.Settings.Joystick.Deadzone)) ? 0 : velocity.X;
			absoluteVector4.W = Mathf.IsEqualApprox(velocity.Y, 0f, Mathf.Max(0.1f, MainViewModel.Settings.Joystick.Deadzone)) ? 0 : velocity.Y;
